            ...
            <div className="1025:col-span-8 col-span-12 flex flex-col gap-6">
              ...
              <div className="flex flex-col  w-[70vw]">
                <Input
                  ...
                  className=" h-10 md:w-[60%] w-full border-2 pl-2 border-primary-a focus:outline-none focus:border-primary-a text-secondary-a hover:opacity-75"
                />
                <Button
                  ...
                  className="mt-2 bg-primary-a text-secondary-b md:w-[30%] h-auto flex justify-center items-center font-bold text-xs sm:text-base hover:opacity-75 rounded-lg"
                />
              </div>
            </div>
