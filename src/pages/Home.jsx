...
const Home = () => {
    ...
    const [imageSrc, setImageSrc] = useState('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTcY0hCdAgzbtF2AM8B9ESuvzALzmiDNR9Ow&s');
    ...
    return (
        ...
        <div className='bg-primary-c min-h-screen flex flex-col'>
            ...
            <div className="flex justify-center items-center flex-col bg-primary-a  ">
                ...
                <h1 className="text-secondary-b sm:text-4xl text-2xl font-bold mt-12 ">
                    {header}
                </h1>
